...
const[sizes,Setsizes]=useState("");
    const apidata= async()=>  
    { 
    const data= await fetch(`https://newsapi.org/v2/top-headlines?category=${props.category}&apiKey=${"26dc02fb8f6f45dc993313592a075d1b"}&page=${page}&PageSize=15`);
...
{   
 ...
 {
  setload(true);
    const newsdata= await fetch(`https://newsapi.org/v2/top-headlines?category=${props.category}&apiKey=${"26dc02fb8f6f45dc993313592a075d1b"}&page=${page}&PageSize=10`);
